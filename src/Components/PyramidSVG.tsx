...
export const PyramidSVG = ({ fields }: { fields: (number | "")[] }) => {
  ...
  return (
    <svg
      width="50mm"
      viewBox="0 0 64.807655 44.062744"
      version="1.1"
      id="svg5"
    ...
    >
      ...
      <g id="layer1" transform="translate(-58.152301,-74.565835)">
        ...
        <g id="g851">
          <path
            style={strokeStyle}
            d="M 122.29034,118.28558 91.229152,75.14482 58.838745,118.28558 Z"
            id="path736"
          />
          <path
            style={strokeStyle}
            d="M 69.405227,104.21209 H 112.15748"
            id="path834"
          />
          <path
            style={strokeStyle}
            d="m 81.694834,104.21209 v 14.07349"
            id="path836"
          />
          <path
            style={strokeStyle}
            d="m 100.90554,104.21209 v 14.07349"
            id="path838"
          />
          <path
            style={strokeStyle}
            d="M 79.032969,91.388905 H 102.92483"
            id="path840"
          />
          <path
            style={strokeStyle}
            d="M 90.978899,91.388905 V 104.21209"
            id="path842"
          />
        </g>
      </g>
